...
#[derive(Debug)]
pub struct EthicBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EthicBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EthicBridge processing");
    
    let mut processor = EthicBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EthicBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EthicBridgeProcessor::new(false);
